...
- Added a bounded, wrapping browser-update review warning recommending a portable Export first, a synchronous secondary save mirror, a longer IndexedDB flush window, and automatic recovery when the primary browser filesystem unexpectedly starts empty.
