...
This repository contains the playable **v0.10.1 browser-parity build** for Godot 4.7.1. Ready-to-share packages for browsers, macOS, Windows, and Linux are generated in `release/` from one shared game codebase.
...
```text
release/One Foot Per Second v0.10.1 All Platforms.zip
```
...
1. Open `release/One Foot Per Second v0.10.1 macOS Universal.dmg`.
