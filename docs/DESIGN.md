...
Save version 23 persists body age, BODY modifiers, and the toddler-clear proof in addition to the explicit pitch phase, hidden pending outcome, selected pitch ID, exact sampled release/plate speed and drag, release distance, original and remaining duration, generated batter identity/loadout, live Strike and Ball counts, 15 additive Training axes, 84 Facilities, cooldown, eight result totals, strikeouts, currencies, upgrades, mastery, outcome-weighted Frustration, manual and automatic tap accounting, unbounded clicker ranks, per-stat/per-catalog automation choices, human and alien Auto-advance capacity, loot with its defeated-batter source, favorites, equipment, Scrap, pity, 109 achievement IDs and trigger history, filters, No Hitter eligibility, peak records, and lifetime statistics. Version 23 accepts every v22 rank and adds new prestige keys at zero; older distance, age, Frustration, automation, loot, and Training migrations remain intact.
