...
const STORY_BEATS := [
	...
	{"id": "human_majors", "tier": "human", "title": "THE SHOW", "body": "The last mortal league is waiting. Nobody here is impressed by your Wiffle-ball origin story."},
	{"id": "bambino_arrival", "tier": "human", "title": "BAMBINO REX", "body": "The last human champion enters and does not intend to leave because you filled a progress bar. Only a strikeout ends this age of baseball."},
	...
	{"id": "first_rebirth", "tier": "genetic", "title": "BORN AGAIN, WITH NOTES", "body": "You wake up as a toddler again. Your DNA remembers the future; your clothes mostly do not. Genetic upgrades persist across every later time travel."},
	...
	{"id": "octathulhu_contact", "tier": "eldritch", "title": "SOMETHING WANTS TO PLAY", "body": "Eight bats unfold beyond the scoreboard. The thing holding them has mistaken the universe for a baseball."},
	{"id": "universe_eaten", "tier": "eldritch", "title": "FINAL SCORE: UNIVERSE 0", "body": "Octathulhu hits another Grand Slam and eats the stadium, the league, and causality in that order."},
	{"id": "first_eldritch_rebirth", "tier": "eldritch", "title": "A LESS DOOMED REALITY", "body": "Your consciousness lands in another backyard. Copies of you from nearby realities have also received the memo."},
	{"id": "earth_defense", "tier": "eldritch", "title": "EARTH'S BULLPEN", "body": "The mound is Earth. The bullpen is orbit. The opposing lineup is approaching from every planet."},
