...
const STORY_BEATS := [
	...
	{"id": "arrive_high_school", "tier": "human", "title": "FRIDAY-NIGHT LIGHTS", "body": "There are recruiters behind the backstop now. A bad pitch is no longer merely humiliating; it is professionally documented. You take the mound anyway, because destiny has acquired a clipboard."},
	...
	{"id": "arrive_upper_minors", "tier": "human", "title": "ONE CALL AWAY", "body": "Every batter has packed for the majors. Each at-bat is a job interview conducted with a maple bat and no human resources department. Yet the same impossible signs keep appearing in every scouting report: four columns, a red diamond, a game nobody remembers scheduling. Your obsession feels less like ambition than a replay from a season reality forgot."},
	{"id": "arrive_major_leagues", "tier": "human", "title": "THE SHOW", "body": "The last mortal league is waiting. Nobody here is impressed by your Wiffle-ball origin story, which is rude because it was clearly prophetic. The cameras linger on a fourth empty seat behind home plate. They have the bats to prove it; you have the mound."},
	...
	{"id": "xylophax_portal", "tier": "genetic", "title": "YOU THINK YOU'RE HOT STUFF", "body": "A portal opens over the diamond. An alien crowd is already booing in several frequencies. Their invasion bracket has reached Earth, and its human-esque champion carries four bats. Xylophax asks whether humanity sent its best toddler."},
	...
	{"id": "alien_olympus", "tier": "genetic", "title": "OLYMPUS MOUND", "body": "Xylophax waits across Mars with four bats and the authority to call this regulation distance. By alien baseball law, Earth was declared lost when its champion fell; your rebirth has made that paperwork embarrassingly premature."},
	{"id": "octathulhu_contact", "tier": "eldritch", "title": "SOMETHING WANTS TO PLAY", "body": "Your impossible pitching has torn a seam through the standings and into older realities. Eight bats unfold beyond the scoreboard, each held by an arm that should not have an elbow. Octathulhu will eat the universe unless you beat him at baseball. Take the mound before the elder gods file a roster correction."},
	...
	{"id": "first_eldritch_rebirth", "tier": "eldritch", "title": "A LESS DOOMED REALITY", "body": "Your consciousness lands in another backyard. Copies of you from nearby realities have also received the memo. The universe has a bullpen now, and its eldritch clipboard is somehow in triplicate."},
	...
	{"id": "god_offer", "tier": "divine", "title": "WOULDN'T THE BEST REWARD BE DOING IT AGAIN?", "body": "God thanks you for saving creation and offers to reset absolutely everything. The benefits office has, somehow, prepared a bonus package."},
	{"id": "alien_arrival_popup", "tier": "genetic", "title": "SO YOU THINK YOU'RE HOT STUFF", "body": "The stadium folds inside out. You, the mound, and several confused alien hot-dog vendors are teleported beneath a sky full of cheering aliens. Their human-esque champion has finished Earth's invasion-bracket game, and Commissioner Xylophax now steps to the plate with four bats. By baseball law, he declares Earth lost; then he demonstrates why the Power display has begun laughing at you."},
	{"id": "eldritch_arrival_popup", "tier": "eldritch", "title": "SOMETHING WANTS TO PLAY", "body": "The alien crowd stops making noise. Your pitching has opened a seam past their bracket and into something older; eight bats unfold beyond the scoreboard, each held by something too large for the current reality. Octathulhu has mistaken the universe for a baseball. It would like to bat."},
	{"id": "alien_help_popup", "tier": "genetic", "title": "A MAN STEPS OUT OF A PORTAL", "body": "He watches Xylophax turn another perfect pitch into an unavoidable Grand Slam. Then he lowers his sunglasses. “Come with me if you want to… be really good at baseball.” He has a Time Machine and an alarming prenatal genetics waiver. Getting into the portal will restart this life immediately."},
	{"id": "genetic_rebirth_explanation_popup", "tier": "genetic", "title": "WELCOME BACK, TINY", "body": "You wake up as a toddler again. Baseball chronology is optional. You gained {{DNA_AWARD}} DNA. Spend it in BODY → DNA on permanent genetic upgrades before growing through the human leagues again. All prestige upgrades are retained on later genetic rebirths."},
	{"id": "endless_unlocked", "tier": "divine", "title": "EXTRA INNINGS", "body": "Octathulhu is out again. God quietly admits that the official scorebook ends here, then points toward an infinite on-deck circle full of increasingly unreasonable opponents. You may enter Extra Innings—or reset the universe again whenever you prefer."},
]
